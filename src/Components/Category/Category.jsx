    ...
    <div className="w-full flex flex-col  gap-3">
      <div>
        <div className="flex justify-center w-full gap-3 px-4">
          {/* 1st-card */}
          <div
            className="rounded overflow-hidden shadow-lg bg-gray-950"
        ...
        <div className="flex justify-center w-full   md:flex-row sm:p-4 gap-2 items-center px-4 my-4">
          ...
          {/* 3st-card */}
          <div
            className="q rounded overflow-hidden shadow-lg bg-gray-950"
        ...
        <div className="flex justify-center w-full px-4">
          {/* 1st-card */}
          <div
            className="max-w-sm rounded overflow-hidden shadow-lg  bg-gray-950"
